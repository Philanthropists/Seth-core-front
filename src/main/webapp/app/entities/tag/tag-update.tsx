  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="solidaridadApp.tag.home.createOrEditLabel">Create or edit a Tag</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="tag-post">Post</Label>
                <AvInput id="tag-post" type="select" className="form-control" name="post.id">
                  <option value="" key="0" />
                  {posts
